...
const consolidateEvaluationsNode = async (
  ...
  if (updatedHistory.length > 0) {
    ...
    if (lastEntry) {
      updatedHistory[lastIndex] = {
        ...lastEntry,
        rewrittenText: lastEntry.rewrittenText || "", // Ensure rewrittenText is always a string
        rationale: lastEntry.rationale || "", // Ensure rationale is always a string
  ...
  // Clear current feedback to prepare for next iteration
  return {
